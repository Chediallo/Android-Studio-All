...
public class EnregistrerAudio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enregistrer_audio);
    ...
    private void RequestPermissions() {
        ...
        ActivityCompat.requestPermissions(EnregistrerAudio.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE}, REQUEST_AUDIO_PERMISSION_CODE);
    }
